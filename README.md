...
│
▼
[ 5. Tool-Gated Writeback: Append-Only Audit Persistence in ClickHouse ]
...
5. **Deterministic Policy Gate:** Validates record existence, variance thresholds (> 2%), confidence scores (≥ 0.60), and allowlisted actions before authorizing database writebacks.
